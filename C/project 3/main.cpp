...
int main(){
    ...
    */
    ...
    Skill stest("stest", "stester", SOFTWARE, 30);
    Profemon ptest("ptest", 26000, HARDWARE);
    Skill stestd;
    Profemon ptestd;
    cout<<stest.getName()<<endl;
    cout<<stest.getDescription()<<endl;
    cout<<stest.getTotalUses()<<endl;
    cout<<stest.getSpecialty()<<endl;
    stest.setName("stest1");
    stest.setDescription("stester1");
    stest.setTotalUses(20);
    cout<<stest.setSpecialty(2);
    cout<<ptest.getName()<<endl;
    cout<<ptest.getSpecialty()<<endl;
    cout<<ptest.getLevel()<<endl;
    cout<<ptest.getMaxHealth()<<endl;
    ptest.setName("ptest1");
    ptest.levelUp(50);
    cout<<ptest.getLevel()<<endl;
    ptest.levelUp(1000);
    cout<<ptest.getLevel()<<endl;

    cout<<ptest.learnSkill(0,stest)<<endl;
    ptest.printProfemon(true);
}